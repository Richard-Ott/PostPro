...
[Model,Para] = assignData(num,txt,burial,burialtxt,nuclide); % assign data
...
%% EXPORT THE DATA
% save(['./output/linearAggradation' nuclide '/PostburialProd_' name{1} '_' tag '.mat'], 'Model')                % save model parameters
